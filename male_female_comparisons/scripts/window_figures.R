...
spp="sin"
spp="po"
spp="fpunSin"  #comparing female pun to sin in place of male vs female as in previous
spp="mpunSin"  #comparing male pun to sin in place of male vs female as in previous
...
SEX.CHROM = 'chrXII'
SEX.CHROM = 'chrXIX'
sex.specific = 'pctMaleSpecific'; specific.lab = '% Male Specific'
sex.specific = 'pctFemaleSpecific';specific.lab = '% Female Specific'
sex.specific = 'nFemaleSpecific';specific.lab = 'Female-Specific SNPs'
sex.specific = 'pctFemaleSpecific';specific.lab = '% Specific'


fst = multichrom_len_normalized(df=dat, xcol='BIN_START', ycol='MEAN_FST', sex.chrom=SEX.CHROM, YLAB=bquote(Mean~F[ST]), sex.col = sex.col, other.col = other.col,SPAN=SPAN)
r2 = multichrom_len_normalized(df=dat, xcol='BIN_START', ycol='male_r2', sex.chrom=SEX.CHROM, YLAB=bquote(sex~association~(r^2)), sex.col = sex.col, other.col = other.col,SPAN=SPAN)
ss = multichrom_len_normalized(df=dat, xcol='BIN_START', ycol= sex.specific, sex.chrom=SEX.CHROM, YLAB= specific.lab, sex.col = sex.col, other.col = other.col,SPAN=SPAN)
dp = multichrom_len_normalized(df=dat, xcol='BIN_START', ycol='bedtoolDepth', sex.chrom= SEX.CHROM, YLAB=bquote(log[2]*(M:F~depth)), sex.col = sex.col, other.col = other.col,SPAN=SPAN)
plot_grid(fst, r2, ss, dp, ncol=1, labels = c("A", "B", "C", "D"))
